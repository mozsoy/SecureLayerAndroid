...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            webSocket = MyWebSocket.getInstance(
                    new URI("wss://10.39.71.185:8080/SecureServer/actions"),
                    new Draft_17(), null, 0,
                    myKeyStore);
        ...
        mEmailView.setText("jay@yahoo.com");
    ...
    /**
     * @param password as typed by user
     * @return true - if password has minimum of 8 characters, else false
     */
    ...
    /**
     * user credentials are verified by server and are valid
     */
...
//            myKeyStore.generatePassword(mPassword);
        ...
        protected void onPostExecute(final Boolean success) {
            // success is return value from doInBackground() method
            mAuthTask = null;
            if (success) {
                loginSuccess();
            } else {    // if the login fails then tell that password is incorrect regardless of email being correct or not
                showProgress(false);
